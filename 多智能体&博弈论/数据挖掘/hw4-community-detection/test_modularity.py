...
def _get_graph():
    TEST_GRAPH_FILE = "./data/test_graph.csv"
...
class TestDeltaModularity(unittest.TestCase):
    ...
    def test_delta_modularity(self):
        ...
        # print("output:", dq, "   expected:", 0.0)

        # TODO (optional): Add more test cases to cover your implementation
        # E.g., add some node x into the community and calculate D(x -> {1})
        #       use assertAlmostEqual to test against the expected value
        #       you can derive the expected value manually or use `networkx`
        # NOTE: You are ONLY ALLOWED to use `networkx` for this optional task
        #       It should NOT be used in your main implementation
        ...
        # print("output:", dq, "   expected:", 0 - 0.04119511090991399)
